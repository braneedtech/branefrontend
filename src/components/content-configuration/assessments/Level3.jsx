...
const Level3 = ({ assessment_questions }) => {
    ...
    if (allCorrect) {
      try {
        ...
        const response = await axios.post(`${end_point}/assessment-submit`, {
          ...
          "iterations": totalSubmissions+1,
          "grade": getGrade(totalSubmissions+1),
